#!/bin/bash
# ============================================================
# GCP: Llama-3.1-8B Complete Training Pipeline
# ============================================================
#
# End-to-end workflow:
#   Step 0: Environment setup (venv + dependencies)
#   Step 1: HuggingFace login (Llama is gated)
...
#   bash gcp/llama_8b_pipeline.sh
#
# To skip steps that are already done:
#   SKIP_SETUP=1 SKIP_DATA=1 bash gcp/llama_8b_pipeline.sh
#
# To use multi-GPU:
#   NUM_GPUS=8 CONFIG=configs/llama_8b_fullft_h100_8gpu.json bash gcp/llama_8b_pipeline.sh
#
# ============================================================
...
TOKENIZED_PATH="${DATASET_PATH}_tokenized_llama"
...
echo "============================================================"
echo "  Llama-3.1-8B Complete Training Pipeline"
echo "============================================================"
...
if [ -n "${HF_TOKEN:-}" ]; then
    ...
    echo ""
    echo "Llama-3.1-8B is a gated model. You need to:"
...
"
        ...
        # Use existing download_data.sh logic inline
...
echo ""
echo "========================================"
echo "[5/5] Starting Llama-3.1-8B training..."
echo "========================================"
echo "  Config : $CONFIG"
echo "  GPUs   : $NUM_GPUS"
echo ""
...
echo "  2. Download model: gcloud compute scp --recurse VM:~/LLM/models/llama-3.1-8b-mental-health-fullft-a100 ./models/ --zone=ZONE"
